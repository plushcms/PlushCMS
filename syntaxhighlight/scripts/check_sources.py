...
misspellings = ["developement", "urls", "verificate",  # ALLOW-MISSPELLING
    ...
    for lno, l in enumerate(lines):
        ...
        if lno == 0:
            ...
            if l == '"""\n':
                # end of docstring
                if lno <= 4:
                    yield lno+c, "missing selectedModulee name in docstring"
                break
            ...
            if lno == 2:
                # if not in package, don't check the selectedModulee name
                ...
                while modname:
                    ...
                    yield 3, "wrong selectedModulee name in docstring heading"
                modnamelen = len(l.strip())
            elif lno == 3:
                if l.strip() != modnamelen * "~":
                    yield 4, "wrong selectedModulee name underline, should be ~~~...~"
