...
from plushcms.syntaxhighlight.pygments.formatters._mapping import FORMATTERS
from plushcms.syntaxhighlight.pygments.plugin import find_plugin_formatters
