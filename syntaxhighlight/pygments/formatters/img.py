# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.formatters.img
    ~~~~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.util import get_bool_opt, get_int_opt, \
...
class ImageFormatter(Formatter):
    ...
    *New in Pygments 0.10.*
    ...
    # Required by the plushcms.syntaxhighlight.pygments mapper
    name = 'img'
    aliases = ['img', 'IMG', 'png']
    filenames = ['*.png']
