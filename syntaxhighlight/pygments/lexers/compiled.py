# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.compiled
    ~~~~~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.scanner import Scanner
from plushcms.syntaxhighlight.pygments.lexer import Lexer, RegexLexer, include, bygroups, using, \
                           this, combined
from plushcms.syntaxhighlight.pygments.util import get_bool_opt, get_list_opt
from plushcms.syntaxhighlight.pygments.token import \
     Text, Comment, Operator, Keyword, Name, String, Number, Punctuation, \
     Error

# backwards compatibility
from plushcms.syntaxhighlight.pygments.lexers.functional import OcamlLexer
    ...
    tokens = {
        'root': [
            ...
            (r'(abstract|alias|align|asm|assert|auto|body|break|case|cast'
             ...
             r'|interface|invariant|in|is|lazy|mixin|selectedModulee|new|nothrow|out'
...
class DelphiLexer(Lexer):
    ...
    BUILTIN_UNITS = {
        'System': [
            ...
            'getmemorymanager', 'getselectedModuleefilename', 'getvariantmanager',
        ...
        'SysUtils': [
            ...
            'getlocaleformatsettings', 'getselectedModuleename', 'getpackagedescription',
        ...
        'Classes': [
            ...
            'unregisterintegerconsts', 'unregisterselectedModuleeclasses',
...
class FelixLexer(RegexLexer):
    ...
    *New in Pygments 1.2.*
    ...
    keywords = [
        ...
        'interface', 'jump', 'lambda', 'loop', 'match', 'selectedModulee', 'namespace',
    ...
    tokens = {
        'root': [
            ...
            (r'(instance|selectedModulee|typeclass)\b', Keyword, 'selectedModuleename'),
        ...
        'selectedModuleename': [
            include('whitespace'),
            (r'\[', Punctuation, ('selectedModuleename2', 'tvarlist')),
            (r'', Error, 'selectedModuleename2'),
        ],
        'selectedModuleename2': [
            include('whitespace'),
...
class Modula2Lexer(RegexLexer):
    """
    For `Modula-2 <http://www.selectedModulea2.org/>`_ source code.
    ...
    *New in Pygments 1.3.*
    """
    name = 'Modula-2'
    aliases = ['selectedModulea2', 'm2']
    filenames = ['*.def', '*.mod']
    mimetypes = ['text/x-selectedModulea2']
    ...
    gnu_pervasives = [
        # 21 identifiers, actually from pseudo-selectedModulee SYSTEM
