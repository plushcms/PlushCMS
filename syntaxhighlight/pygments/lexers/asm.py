# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.asm
    ~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.lexer import RegexLexer, include, bygroups, using, DelegatingLexer
from plushcms.syntaxhighlight.pygments.lexers.compiled import DLexer, CppLexer, CLexer
    ...
    tokens = {
        ...
        'keyword': [
            ...
            (r'(begin|end'
             ...
             r'|addrspace|section|alias|selectedModulee|asm|sideeffect|gc|dbg'
