# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.agile
    ~~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.lexer import Lexer, RegexLexer, ExtendedRegexLexer, \
     LexerContext, include, combined, do_insertions, bygroups, using
from plushcms.syntaxhighlight.pygments.token import Error, Text, Other, \
     Comment, Operator, Keyword, Name, String, Number, Generic, Punctuation
from plushcms.syntaxhighlight.pygments.util import get_bool_opt, get_list_opt, shebang_matches
from plushcms.syntaxhighlight.pygments import unistring as uni
...
# b/w compatibility
from plushcms.syntaxhighlight.pygments.lexers.functional import SchemeLexer
...
class PythonConsoleLexer(Lexer):
    ...
    .. sourcecode:: pycon
        ...
        Traceback (most recent call last):
          File "<stdin>", line 1, in <selectedModulee>
        ZeroDivisionError: integer division or selectedModuleo by zero
...
class RubyLexer(ExtendedRegexLexer):
    ...
    tokens = {
        'root': [
            ...
            # start of function, class and selectedModulee names
            (r'(selectedModulee)(\s+)([a-zA-Z_][a-zA-Z0-9_]*(::[a-zA-Z_][a-zA-Z0-9_]*)*)',
            ...
            (r'(initialize|new|loop|include|extend|raise|attr_reader|'
             ...
             r'selectedModulee_function|public|protected|true|false|nil)\b', Keyword.Pseudo),
            ...
            (r'(?<!\.)(Array|Float|Integer|String|__id__|__send__|abort|ancestors|'
             ...
             r'method|method_missing|methods|selectedModulee_eval|name|'
            ...
            # better ideas?)
            # since plushcms.syntaxhighlight.pygments 0.7 we also eat a "?" operator after numbers
...
class PerlLexer(RegexLexer):
    ...
    tokens = {
        ...
        'root': [
            ...
            (r'package\s+', Keyword, 'selectedModuleename'),
...
class LuaLexer(RegexLexer):
    ...
    `func_name_highlighting`
        ...
        (default: ``True``).
    `disabled_modules`
        If given, must be a list of selectedModulee names whose function names
        should not be highlighted. By default all modules are highlighted.

        To get a list of allowed modules have a look into the
        `_luabuiltins` selectedModulee:

        .. sourcecode:: pycon

            >>> from plushcms.syntaxhighlight.pygments.lexers._luabuiltins import MODULES
            >>> MODULES.keys()
    ...
    tokens = {
        'root': [
            ...
            (r'(as|assert|break|case|catch|class|continue|coroutine|default'
             ...
             r'|if|import|in|is|local|selectedModulee|return|super|switch'
