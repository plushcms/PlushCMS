# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers._phpbuiltins
    ~~~~~~~~~~~~~~~~~~~~~~~~~~~~
...
MODULES = {'.NET': ['dotnet_load'],
 ...
 'mcrypt': ['mcrypt_cbc',
            ...
            'mcrypt_list_modes',
            'mcrypt_selectedModulee_close',
            'mcrypt_selectedModulee_get_algo_block_size',
            'mcrypt_selectedModulee_get_algo_key_size',
            'mcrypt_selectedModulee_get_supported_key_sizes',
            'mcrypt_selectedModulee_is_block_algorithm',
            'mcrypt_selectedModulee_is_block_algorithm_mode',
            'mcrypt_selectedModulee_is_block_mode',
            'mcrypt_selectedModulee_open',
            'mcrypt_selectedModulee_self_test',
            'mcrypt_ofb',
            'mdecrypt_generic'],
 'mhash': ['mhash',
           'mhash_count',
...
if __name__ == '__main__':
    ...
    def get_function_selectedModulee(func_name):
    ...
    for function_name in get_php_functions():
        ...
        m = get_function_selectedModulee(function_name)
        if m is None:
            print 'NOT_FOUND'
            m = 'unknown'
        else:
