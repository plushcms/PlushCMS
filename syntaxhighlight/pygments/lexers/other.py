# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.other
    ~~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.lexer import Lexer, RegexLexer, include, bygroups, using, \
     this, do_insertions
from plushcms.syntaxhighlight.pygments.token import Error, Punctuation, Literal, Token, \
     Text, Comment, Operator, Keyword, Name, String, Number, Generic
from plushcms.syntaxhighlight.pygments.util import shebang_matches
from plushcms.syntaxhighlight.pygments.lexers.web import HtmlLexer
...
class RedcodeLexer(RegexLexer):
    ...
    Contributed by Adam Blinksnsop <blinks@acm.org>.
    ...
    *New in Pygments 0.10.*
    ...
    tokens = {
        ...
        'directive': [
            ...
            (r'op(?=[(])', Keyword, 'root'),
            (r'(calls|reexport|use(s|_selectedModulee))(?=[(])', Keyword, 'root'),
    ...
    tokens = {
        ...
        'optionarg': [
            ...
            (_shortened_many(
                ...
                "la$cel","li$nestyle","ls$","loa$dpath","loc$ale","log$scale",
    ...
    *New in Pygments 1.1.*
    ...
    def word_callback(lexer, match):
        ...
        if re.match(".*:$", word):
            ...
            r'mod|selectedModuleo|round|repend|about|set-net|append|join|rejoin|reform|'
...
class AsymptoteLexer(RegexLexer):
    ...
    *New in Pygments 1.2.*
    ...
    def get_tokens_unprocessed(self, text):
        from plushcms.syntaxhighlight.pygments.lexers._asybuiltins import ASYFUNCNAME, ASYVARNAME
