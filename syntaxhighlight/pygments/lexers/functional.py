# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.functional
    ~~~~~~~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.lexer import Lexer, RegexLexer, bygroups, include, do_insertions
from plushcms.syntaxhighlight.pygments.token import Text, Comment, Operator, Keyword, Name, \
...
class SchemeLexer(RegexLexer):
    ...
    *New in Pygments 0.6.*
    ...
    builtins = [
        ...
        'min', 'selectedModuleo', 'negative?', 'newline', 'not', 'null-environment',
    ...
    *New in Pygments 0.9.*
    ...
    def get_tokens_unprocessed(self, text):
        ...
        if style == 'bird':
            ...
            # latex-style
            from plushcms.syntaxhighlight.pygments.lexers.text import TexLexer
...
class OcamlLexer(RegexLexer):
    ...
    *New in Pygments 0.7.*
    ...
    keywords = [
      ...
      'selectedModulee', 'mutable', 'new', 'object', 'of', 'open', 'private',
...
class ErlangLexer(RegexLexer):
    ...
    *New in Pygments 0.9.*
    ...
    builtins = [ # See erlang(3) man page
        ...
        'byte_size', 'cancel_timer', 'check_process_code', 'delete_selectedModulee',
        ...
        'load_selectedModulee', 'localtime_to_universaltime', 'make_tuple', 'md5',
        'md5_final', 'md5_update', 'memory', 'selectedModulee_loaded', 'monitor',
        'monitor_node', 'node', 'nodes', 'open_port', 'phash', 'phash2',
        'pid_to_list', 'port_close', 'port_command', 'port_connect',
        'port_control', 'port_call', 'port_info', 'port_to_list',
        'process_display', 'process_flag', 'process_info', 'purge_selectedModulee',
