# -*- coding: utf-8 -*-
"""
    plushcms.syntaxhighlight.pygments.lexers.text
    ~~~~~~~~~~~~~~~~~~~~
...
from plushcms.syntaxhighlight.pygments.lexer import Lexer, LexerContext, RegexLexer, ExtendedRegexLexer, \
     bygroups, include, using, this, do_insertions
from plushcms.syntaxhighlight.pygments.token import Punctuation, Text, Comment, Keyword, Name, String, \
     Generic, Operator, Number, Whitespace, Literal
from plushcms.syntaxhighlight.pygments.util import get_bool_opt
from plushcms.syntaxhighlight.pygments.lexers.other import BashLexer
...
class RstLexer(RegexLexer):
    ...
    *New in Pygments 0.7.*
    ...
    def _handle_sourcecode(self, match):
        from plushcms.syntaxhighlight.pygments.lexers import get_lexer_by_name
...
class VimLexer(RegexLexer):
    ...
    *New in Pygments 0.8.*
    ...
    def __init__(self, **options):
        from plushcms.syntaxhighlight.pygments.lexers._vimbuiltins import command, option, auto
        self._cmd = command
        self._opt = option
        self._aut = auto
